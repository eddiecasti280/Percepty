  ...
  return (
    <div className="module-page">
      ...
      <KnowledgePartition id="partition2">
        <p>
          Breaking the equation apart, the individual numbers being added are
          called the <strong>addends</strong>:
        </p>
        <LatexSnippet latex="\boxed{1} + \boxed{2} = 3" displayMode />
      </KnowledgePartition>

      <KnowledgePartition id="partition3">
        <p>The result is called the <strong>sum</strong>:</p>
      ...
      <KnowledgePartition id="partition5">
        <p>
          The <strong>minuend</strong> is the value being subtracted from:
        </p>
      ...
      <KnowledgePartition id="partition7" isLast>
        <p>The result is called the <strong>difference</strong>:</p>
