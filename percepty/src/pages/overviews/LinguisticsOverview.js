...
import { linguisticsModuleGroups, getMergedGroups } from '../../utils/moduleData';
...
function LinguisticsOverview() {
  const groups = getMergedGroups(linguisticsModuleGroups, 'linguistics');
  return (
    <div className="overview-page">
      <div className="overview-banner">
        <div className="overview-banner-text">
          <h1>Linguistics</h1>
          <p>Discover the structures behind human language — from writing systems and phonetics to morphology and syntax.</p>
        </div>
        <div className="overview-banner-img">
          <img src={process.env.PUBLIC_URL + '/school_lounging_img.svg'} alt="Lounging illustration" />
        </div>
      </div>
      {groups.map((group) => (
