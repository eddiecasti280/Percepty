...
/**
 * Quiz component for end-of-module practice questions.
 *
 * @param {Array} questions - Array of question objects:
 *   {
 *     question: string,          // The question text
 *     latex?: string,            // Optional LaTeX to display with the question
 *     options: string[],         // Array of answer choices
 *     optionsLatex?: string[],   // Optional LaTeX for each option
...
function Quiz({ questions, title = 'Practice Questions' }) {
  ...
  const handleSelect = (optionIndex) => {
    if (revealed[currentQuestion]) return; // Already answered
    ...
    return (
      <div className="quiz-container">
        ...
        <div className="quiz-results">
                  ...
                  <div className="quiz-result-content">
                    ...
                    <p className="quiz-result-answer">
                      ...
                      {q.optionsLatex ? (
                        <span className="inline-latex">
                          <BlockMath math={q.optionsLatex[selectedAnswers[idx]] || '—'} />
                        </span>
                      ) : (
                    ...
                    {!isCorrect && (
                      <p className="quiz-result-correct">
                        ...
                        {q.optionsLatex ? (
                          <span className="inline-latex">
                            <BlockMath math={q.optionsLatex[q.correctIndex]} />
                          </span>
                        ) : (
          ...
          <button className="quiz-btn quiz-btn-reset" onClick={handleReset}>
            Try Again
          </button>
        </div>
      </div>
  ...
  return (
    <div className="quiz-container">
      ...
      <div className="quiz-question">
        ...
        {current.latex && (
          <div className="quiz-question-latex">
          ...
          return (
            ...
            >
              ...
              {current.optionsLatex ? (
                <span className="quiz-option-latex">
                  <BlockMath math={current.optionsLatex[idx]} />
                </span>
              ) : (
      ...
      <div className="quiz-actions">
        ...
        {!isRevealed && selectedOption !== undefined && (
          <button className="quiz-btn quiz-btn-check" onClick={handleReveal}>
            Check Answer
          </button>
        )}
      ...
      <div className="quiz-footer">
        <button className="quiz-reset-link" onClick={handleReset}>
          Reset Quiz
        </button>
      </div>
    </div>
